...
One of them - create a music using short codes - it looks interesting :

Bytebeat Music Competition. 
Create music with just simple logical formulas in 256 characters or less using short code :
